...
type GeneralSecondProps = HTMLAttributes<HTMLDivElement> & {
  isModal?: boolean
}

export const GeneralSecond: React.FC<GeneralSecondProps> = ({
  isModal = false,
  className,
  ...props
}) => {
  return (
    <div
      ...
      {...props}
    >
      <div className='h-5/9 bg-[url("/img/general_second_bg_sm_half.svg")] bg-cover bg-center bg-no-repeat md:h-2/3 md:bg-[url("/img/general_second_bg_half.svg")]' />
