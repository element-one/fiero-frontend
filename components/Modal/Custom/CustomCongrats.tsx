...
interface CustomCongratsProps {
  onClose?: () => void
}

export const CustomCongratsModal: React.FC<CustomCongratsProps> = ({
  onClose,
}) => {
  ...
  return (
    <Transition
      appear
      show={isModalShown(ModalType.CUSTOM_CONGRATS_MODAL)}
      as={Fragment}
    >
...
export default CustomCongratsModal
