          ...
          <div className='mx-7 mt-7 ease-linear md:mt-14'>
            <div className='m-auto max-w-[1200px] text-left font-sans text-[14px] leading-6 text-text-black'>
              ...
              <Text variant='ls' className='text-text-black'>
                This Privacy Policy pertains to the Fiero Tequila Rewards website and other
                services (collectively, the <span className='font-bold'>“Services”</span>) made available to you by GlassDAO
                Corporation (<span className='font-bold'>“GLASS”, “we”, “our”, “us”</span>). This Privacy Policy is intended to
                inform our users (“<span className='font-bold'>user(s)</span>”,
                “<span className='font-bold'>you</span>”, or “<span className='font-bold'>your</span>”)
                about how we may collect and use
                the personal information that you provide through your use of and access to the
                Services, the manner in which we may use such information, how we protect it,
                and the choices available to you regarding our use of your personal information.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                We collect different types of information for various purposes to provide you with
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                While using the Services, we may ask you to provide us with certain information
                that can be used to contact or identify you or otherwise to provide the Services to
                you (“
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                We may also collect information that your browser and/or mobile device sends
                whenever you access or use the Services (“
                <span className='font-bold'>Usage Data</span>”).
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
                This Usage Data may include information such as your computer’s Internet
                Protocol address, browser type, browser version, the pages of our Service that
                you visit, the time and date of your visit, the time spent on those pages, unique
                device identifiers and other diagnostic data.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
                When you access the Services with a mobile device, this Usage Data may include
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                We use cookies and similar tracking technologies to track the activity on the
                Services.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
                ...
                scripts to collect and track information and to help us improve and analyze the
                Services.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
              ...
              <ol className='list-decimal pl-12'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    to provide information regarding the availability of Services based on your
                    location;
                  </Text>
                </li>
                <li>
              ...
              <Text variant='ls' className='text-text-black'>
                ...
                strengthen the security or to improve the functionality of the Services, or we are
              ...
              <Text variant='ls' className='text-text-black'>
                If you are located outside of the United States and choose to provide information
                to us, please note that we transfer the data, including Personal Data, to the United
              ...
              <ol className='list-decimal pl-12'>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    to fulfill the purpose for which you provide it, including by sharing your
                    Personal Data with other partners that may provide services requested by you
                    in order for such service providers and partners to contact you, as you have
                    requested as part of the Services;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    if we believe disclosure is necessary or appropriate to protect our rights,
                    property, or safety or the rights, property or safety of our customers or others;
                    and
                  </Text>
                </li>
                <li>
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                Under some U.S. state laws, including the California Consumer Privacy Act of
                2018 (CCPA) and the California Privacy Rights Act (CPRA), residents may have the
                following rights:
              </Text>
              <br />
              <ol className='list-decimal pl-12'>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Know: The right to request the personal data that we collect, use or
                    disclose and information about our data practices;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Request Deletion: The right to request that we delete the personal
                    data we have collected about you;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Opt-Out of Data Sales and Sharing: The right to restrict the sale or
                    sharing of your personal data we have collected to third parties;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Non-Discrimination: The right to not be discriminated against for
                    exercising any of these rights;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Correct Information: The right to update or correct the personal data
                    that we collect;
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Limit Use or Disclosure of Sensitive Personal Information: The right to
                    limit the use and disclosure of Sensitive Personal Information (as defined
                    under the CPRA);
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Access Information Related to Automated Decision Making: The right
                    to inquire about our logic involved in automated decision-making applied to
                    personal data we collect; and
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Right to Opt-Out of Automated Decision-Making Technology: The right to
                    request your removal from having automated decision-making applied to your
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                California Civil Code Section 1798.83 permits California residents to request and
                obtain a list of what personal information (if any) that we disclosed to third parties
                for direct marketing purposes in the preceding calendar year and the names and
                addresses of those third parties. Requests may be made only once a year and are
                free of charge. Under Section 1798.83, California residents are entitled to request
                and obtain such information, by e-mailing a request to{' '}
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                To exercise your rights, please contact us at cheers@glass.fun. Note that these
                rights are not absolute, are subject to exceptions and limitations, and may not be
                afforded to residents of all states.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
                Only you or an authorized agent may make a request related to your Personal
                Data. Note that to respond to your requests, we must verify your identity and
                reserve the right to confirm your state residency.
              </Text>
              <br />
              <Text
                variant='b1'
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                Do Not Track is a privacy preference that you can set in your browser. We
                recognize and respond to Do Not Track signals. When you have Do Not Track
                enabled, we may still use Personal Data for analytics and measurement purposes
                or to otherwise provide our Service.
              </Text>
              <br />
              <Text
                variant='b1'
              ...
              <Text variant='ls' className='text-text-black'>
                ...
                (“Service Providers”), provide the Services on our behalf, perform Service-related
                Fiero Privacy Policy 7
                services or assist us in analyzing how the Services are used.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                We may use third-party Service Providers to monitor and analyze the use of the
                Services.
              </Text>
              <br />
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                Some content, including advertisements, on the website is provided by third-parties,
                including advertisers, ad networks and servers, content providers and
                application providers. These third parties may use cookies alone or in conjunction
                with web beacons or other tracking technologies to collect information about you
                when you use our Service. The information they collect may be associated with
                ...
                interest-based (behavioral) advertising or other targeted content. We do not
                control these third parties tracking technologies or how they may be used. If you
                have any questions about an advertisement or other targeted content, you should
              ...
              <br />
              <Text variant='ls' className='text-text-black'>
                Our Services are not intended for use by persons under the age of 21.
              </Text>
              <br />
              <Text variant='ls' className='text-text-black'>
                We do not knowingly collect personally identifiable information from persons
                under 21. If you become aware that a person under 21 has provided us with
                Personal Data, please contact us at{' '}
                <a href='mailto:cheers@glass.fun' className='text-text-primary'>
                  cheers@glass.fun
                </a>
                .  If we become aware that
                we have collected Personal Data from a person under 21 without verification of
