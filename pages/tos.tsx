    ...
    <div className='min-h-screen bg-bg-gray-yellow'>
      <div className='container mx-auto bg-bg-gray-yellow pb-10'>
        ...
        <div className='flex h-[138px] w-full items-center justify-center px-9 text-center text-[18px] font-semibold  text-text-primary md:text-[42px]'>
          Harpoon Rewards Terms and Conditions
        </div>
          ...
          <div className='mx-7 mt-7 text-text-black ease-linear md:mt-14'>
            <div className='m-auto max-w-[1200px] text-left font-sans text-[14px] leading-6'>
              ...
              <Text variant='b1' className='text-[14px] text-text-black'>
                These Terms and Conditions (collectively, the “Terms”) govern all access to and participation in the Community Program (the “Program”), a promotional program for Harpoon by GlassDAO Corporation. (“we” and “us”), and offered to our customers who register for the Program (each, a “Member” or “you”). Please read these Terms carefully. If you do not agree to these Terms, please do not participate in the Program.
              </Text>
              <br />
              <Text
                variant='b1'
              ...
              <ul className='list-disc pl-12'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    No purchase or payment of any kind is needed to participate in the Program as a member.
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    Employees, contractors, directors, officers, and agents of American Spiked Beverages, and its affiliates and subsidiaries, advertising and promotion agencies, wholesale distributors, retail licensees, all other service or governmental agencies and their employees involved with the Services, and members of their immediate families (spouse, parent, child, or sibling; whether biological, adopted, step, or in-law) or households (whether related or not) are not eligible to participate.
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    To become a Member, visit harpoonrewardsclub.com/rewards and provide the required information. By enrolling you represent that the information you provide is accurate and up to date.
                  </Text>
                </li>
                <li>
                  <Text variant='ls' className='text-text-black'>
              ...
              <br />
              <Text variant='b1' className='text-[14px] text-text-black'>
                Any personal information collected about you through the Program, including without limitation any information about you collected through your engagement with the Program, will be governed by our Privacy Policy, available at{' '}
                <a
                  href='https://harpoonrewardsclub.com/'
                  target='_blank'
                  className='text-text-primary'
                >
                  https://harpoonrewardsclub.com/
                </a>
              ...
              <ol className='list-disc pl-12'>
                ...
                <li>
                  <Text variant='ls' className='text-text-black'>
                    These Terms shall be the sole terms of the agreement between you and Glass, Inc. regarding your access to or participation in the Program, except that to the extent you access or use any of our websites, such use shall also be subject to our website terms of use available{' '}
                    <a
